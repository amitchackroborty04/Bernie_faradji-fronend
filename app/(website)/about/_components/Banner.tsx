      ...
      <div className="relative z-10 flex items-center justify-center lg:justify-start pt-24 sm:pt-32 lg:pt-80 min-h-150">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center ">
            {/* Heading */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[60px] font-normal text-center leading-tight tracking-tight text-white">
              {heading}
            </h1>

            {/* Description */}
            <p className="mt-4 w-300 mx-auto sm:mt-6 text-base sm:text-lg md:text-xl text-white/90 leading-7">
              {description}
            </p>
